...
<form action="{{ route('taller20', ['idtaller' => $d]) }}" method="POST" class="mb-3">
	@csrf
	<div class="container">
					...
					<div class="col-10 p-2  ">
						...
						<div class="row">
							...
							<div class="row justify-content-end mt-3">
								<div class="col-10">
									<p class="form-inline text-justify">Me <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp21" type="text">  constituy <input required size="1"   class="form-control mb-1 ml-1 mr-1" name="resp22" type="text"> fiador <input required  size="1"  class="form-control mb-1 ml-1 mr-1" name="resp23" type="text">  llano <input required  size="1"  class="form-control mb-1 ml-1 mr-1" name="resp23" type="text"> pagador <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp24" type="text"> de <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp25" type="text">  señor <input required   class="form-control mb-1 ml-1 mr-1" size="15" name="resp26" type="text"> por las obligaciones que he  <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp27" type="text">  ontraído en el pagaré anterior haciendo de deuda ajena deuda propia renunciando  los beneficios de orden y de excusión de bienes de <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp28" type="text"> deudor <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp29" type="text"> principal  <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp30" type="text"> el de división y cualquier ley, excepción o derecho que pueda favorecer <input required   class="form-control mb-1 ml-1 mr-1" size="1" name="resp31" type="text"> así como la apelación y el recurso de hecho.  Quedo sometido a los jueces de  Provincia o de la que elija el acreedor. Sin protesto.</p>
								</div>
							</div>
							<div class="row">
								<div class="col-6 ">
