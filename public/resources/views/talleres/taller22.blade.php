			...
			<div class="col-9" style="box-shadow: 5px 5px 15px 0px  #27F4AE">
				<div class="row">
					...
					<div class="col-6 text-center p-3">
						...
						<div class="row mb-2">			
							...
							<div class="col-8">
								<input required type="email" name="fecha" class="form-control">
							</div>
						</div>
						<div class="row mb-2">			
							<div class="col-4 text-left">
				...
				<div class="row p-3">
					<table class="table table-bordered">
					  ...
					  <tbody class="prin">
					    <tr>
					      <td><input required name="cantidad[]" type="number" class="form-control text-right" ></td>
					      <td><input required name="codigo[]" type="number" class="form-control text-right" ></td>
					      <td><input required type="text" name="descripcion[]" class="form-control" ></td>
					      <td><input required type="number" name="precio_unit[]" class="form-control text-right" ></td>
					      <td><input required name="total[]" type="number" class="form-control text-right" ></td>
