			...
			<div class="col-10" style="box-shadow: 5px 5px 15px 0px  #F42787">
				...
				<div class="row p-3  mb-2 ">
					<table class="table table-bordered table-sm">
					  ...
					  <tbody class="prin">
					  	<tr>
					  		<td width="100"> <input type="number" name="codigo[]" class="form-control text-right" required></td>
					  		<td width="100"><input type="text" name="cod_aux[]" class="form-control text-right" required></td>
					  		<td width="100"><input type="number" name="cantidad[]" class="form-control text-right" required></td>
					  		<td ><textarea  name="descripcion[]" class="form-control text-right" required></textarea> </td>
					  		<td width="50"><input type="number" name="precio[]" class="form-control text-right" required></td>
					  		<td width="50"><input type="number" name="descuento[]" class="form-control text-right" required></td>
					  		<td width="75"><input type="number" name="valor[]" class="form-control text-right" required></td>
				...
				<div class="col-6 border-danger border align-self-end">
					...
					<div class="row mb-2">
						...
						<div class="col-8"><input required type="text" class="form-control text-right" name="direccion"></div>
					</div>
					<div class="row mb-2">
						<div class="col-4"><label class="col-form-label" for="">Telefono</label></div>
						<div class="col-8"><input required type="text" class="form-control text-right" name="telefono"></div>
					</div>
					<div class="row mb-2">
						<div class="col-4"><label class="col-form-label" for="">Email</label></div>
						<div class="col-8"><input required type="text" class="form-control text-right" name="email"></div>
					</div>
				</div>
				<div class="col-6">
					<table class="table table-bordered">
					  ...
					  <tbody>
					    <tr>
					      ...
					      <td><input required type="NUMBER" name="subtotal_12" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">SUBTOTAL 0%</th>
					      <td><input required type="NUMBER" name="subtotal_0" class="form-control text-right"></td>
					      
					    </tr>
					    <tr>
					      <th scope="row">SUBTOTAL No objeto de IVA</th>
					      <td><input required type="NUMBER" name="subtotal_iva" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">SUBTOTAL Exento de IVA</th>
					      <td><input required type="NUMBER" name="subtotal_siniva" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">SUBTOTAL SIN IMPUESTOS</th>
					      <td><input required type="NUMBER" name="subtotal_sin_imp" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">TOTAL DESCUENTO</th>
					      <td><input required type="NUMBER" name="descuento_total" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">ICE</th>
					      <td><input required type="NUMBER" name="ice" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">IVA {{ $datos->iva }}%</th>
					      <td><input required type="NUMBER" name="iva12" class="form-control text-right"></td>
					    </tr>
					     <tr>
					      <th scope="row">IRBPNR</th>
					      <td><input required type="NUMBER" name="irbpnr" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">PROPINA</th>
					      <td><input required type="NUMBER" name="propina" class="form-control text-right"></td>
					    </tr>
					    <tr>
					      <th scope="row">VALOR TOTAL</th>
					      <td><input required type="NUMBER" name="valor_total" class="form-control text-right"></td>
					    </tr>
