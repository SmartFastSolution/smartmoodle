						...
						<div class="col-10 p-2  ">
							...
							<div class="row justify-content-between">
								<div class="col-5 text-center">
									<input required  type="text" value="ING. JUAN PEREZ" disabled="" class="form-control form-control-sm" disabled value="">
