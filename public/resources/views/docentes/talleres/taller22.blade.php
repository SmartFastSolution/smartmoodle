				...
				<div class="row p-3">
					<table class="table table-bordered">
					  ...
					  <tbody class="prin">
					    ...
					    <tr>
					      <td><input name="cantidad[]" disabled value="{{ $dato->cantidad }}" type="number" class="form-control" ></td>
					      <td><input name="codigo[]" disabled value="{{ $dato->codigo }}" type="number" class="form-control" ></td>
					      <td><input type="text" disabled value="{{ $dato->descripcion }}" name="descripcion[]" class="form-control" ></td>
					      <td><input type="number" disabled value="{{ $dato->precio_unit }}" name="precio_unit[]" class="form-control" ></td>
					      <td><input name="total[]" disabled value="{{ $dato->total }}" type="number" class="form-control" ></td>
					    </tr>
					    @endforeach
					  </tbody>
					</table>
