                        ...
                        <div class="col-5">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Carbon\Carbon::parse($update_imei->pivot->fecha_entregado)->formatLocalized('%d de %B %Y ') }}
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="card-body">
                    ...
                    @isset($datos->archivo)
                        <div class="row justify-content-center mb-5">
                            <a target="_blank" class="btn btn-danger" href="{{ $datos->archivo }}"><i
                                    class="fad fa-file-pdf"></i> Descargar PDF</a>
                        </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-sm-12 col-md-2 mb-3">
                                <div class="list-group" id="list-tab" role="tablist">
                                    @foreach ($modulo as $key => $element)
                                        <a class="list-group-item list-group-item-action @if ($key==0) active @endif"
                                            id="list-{{ $element->code }}-list" data-toggle="list"
                                            href="#list-{{ $element->code }}" role="tab"
                            ...
                            <div class="col-12 col-sm-12 col-md-10">
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'balance_comp') show active @endif "
                                        id="list-balance_comp" role="tabpanel"
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'mayor-general') show active @endif border border-danger "
                                        id="list-mayor-general" role="tabpanel"
                                        aria-labelledby="list-mayor-general-list">
                                        @include('docentes.contabilidad.mayorgeneral')
                                    </div>

                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'hoja-trabajo') show active @endif "
                                        id="list-hoja-trabajo" role="tabpanel"
                                        ...
                                        <ul class="nav nav-tabs" id="bInicial" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" id="home-tab" data-toggle="tab"
                                                    href="#b_horizontal" role="tab" aria-controls="b_horizontal"
                                                    aria-selected="true">Balance Inicial Horizontal</a>
                                            </li>
                                            @if ($datos->metodo == 'individual')

                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" id="profile-tab" data-toggle="tab"
                                                        href="#b_vertical" role="tab" aria-controls="b_vertical"
                                                        aria-selected="false">Balance Inicial Vertical</a>
                                                </li>
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'asento-cierre') show active @endif "
                                        id="list-asento-cierre" role="tabpanel"
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'libro-caja') show active @endif " id="list-libro-caja"
                                        role="tabpanel" aria-labelledby="list-libro-caja-list">
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'arqueo-caja') show active @endif " id="list-arqueo-caja"
                                        role="tabpanel"
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'libro-banco') show active @endif " id="list-libro-banco"
                                        role="tabpanel"
                                    ...
                                    <div class="tab-pane fade @if ($modulo[0]->code ==
                                        'retencion-iva') show active @endif "
                                        id="list-retencion-iva" role="tabpanel"
                ...
                <div class="row justify-content-center">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $update_imei->pivot->calificacion }}" class="form-control"
                                name="calificacion" placeholder="Añada una nota al estudiante">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Retroalimentación</label>
                            <textarea class="form-control" name="retroalimentacion" rows="3"
                                placeholder="Agregue una retroalimentacion">{{ $update_imei->pivot->retroalimentacion }}</textarea>
                        </div>
                        <div class="row justify-content-center mb-5">
