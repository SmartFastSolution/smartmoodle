...
<div class="row p-3 justify-content-center ">
    <div class="col-5 mb-3">
      ...
      <div class="row">    
        <div class="col-7">             
          <h3 class="text-primary">ACTIVOS CORRIENTE <a data-toggle="tooltip" data-placement="top" title="Agregar Activo Corriente"  class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a></h3><br>
