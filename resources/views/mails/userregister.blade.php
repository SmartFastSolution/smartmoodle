                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l">
                                                                                        <p style="line-height: 150%; text-align: justify;">Bienvenido <strong> {{ $name }} {{ $apellido }} </strong>, has sido registrado correctamente en nuestra plataforma, se te asigno una contraseña aleatoria por lo que primero debes iniciar sesion y restablecerla
                                                                                        <br>
                                                                                    Tu correo y contraseña para ingresar son los siguientes:</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p style="text-align: justify;">Si tienes alguna duda puedes contactar con tutor academico, o enviando un correo a nuestro sistema</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="540" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image made_with" align="center" style="font-size: 0px;"><a target="_blank" href="https://smartmoodle/"><img src="https://i.ibb.co/smRbtZH/manconymous.png" alt width="125" style="display: block;"></a></td>
                                                                                </tr>
                                                                                <tr>
