...
@endif
	...
	<div class="card">
		<div class="card-header">
			<h3 class="card-title">Reporte De Docentes</h3>
		</div>
		<!-- /.card-header -->
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th style="vertical-align: middle;" scope="col">Paralelos</th>
				...
				<tbody>
					...
					<tr>
						...
						<td width="200">@foreach ($paralelos = \DB::table('distribuciondo_nivel')->where('distribuciondo_id', $element->id)->get() as $paralelo)
							<span class="badge badge-success">{{ $paralelo->nivel_nombre }}</span>
						@endforeach</td>
						<td>
