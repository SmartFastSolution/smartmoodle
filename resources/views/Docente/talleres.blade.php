                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-gray-dark mt-2">
                            ...
                            <div class="card-body">
                                        ...
                                        <tr v-for="(taller, index) in talleres[{{ $c }}].talleres">
                                            ...
                                            <td>
                                                <a class="btn btn-warning" href=""
                                                    @click.prevent="Cambiar({{ $c }}, index)"> <i
                                            ...
                                            <td>
                                                ...
                                                <div class="onoffswitch">
                                                    <input type="checkbox" name="onoffswitch"
                                                        @change="Cambiar({{ $taller->id }})"
                                                        class="onoffswitch-checkbox"
                                                        id="myonoffswitch.{{ $taller->id }}" tabindex="0" @if
                                                        ($taller['estado']==1) checked @endif>
                                            ...
                                            <td>
                                                <a class="btn btn-warning" href="#" @click="Cambiar({{ $c }},{{ $t }})">
                                ...
                                {{--  <div class="row justify-content-center mt-3"> {{ $tallers->links() }}
                            </div> --}}
