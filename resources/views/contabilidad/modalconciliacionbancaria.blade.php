            ...
            <a class="nav-link bg-dark mb-2" href="" @click.prevent="calculadora()">CALCULADORA</a>
                    ...
                    <div class="col-6 mt-2 ">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-conciliacion-tab" data-toggle="tab" href="#nav-conciliacion" role="tab" aria-controls="nav-conciliacion" aria-selected="true">ENUNCIADOS</a>
                                <a class="nav-link" id="nav-libro-banco-tab" data-toggle="tab" href="#nav-libro-banco" role="tab" aria-controls="nav-libro-banco" aria-selected="false">LIBRO BANCO</a>
                                
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-conciliacion" role="tabpanel" aria-labelledby="nav-conciliacion-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden; border: double 8px #E71822;">
                                @isset ($conciliacionbancaria->transacciones)
                                    {!! $conciliacionbancaria->transacciones !!}
                                @endisset
                            </div>
                            <div class="tab-pane fade" id="nav-libro-banco" role="tabpanel" aria-labelledby="nav-libro-banco-tab" style=" height:300px; overflow-y: scroll; border: double 8px #E71822;  overflow-x: hidden;">
                                <h2 class="text-center  font-weight-bold text-danger">Anexos de Control Interno</h2>
                ...
                @elseif($datos->metodo == 'concatenado')
                      <div class="col-6 mt-2 ">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-conciliacion1-tab" data-toggle="tab" href="#nav-conciliacion1" role="tab" aria-controls="nav-conciliacion1" aria-selected="true">ENUNCIADOS</a>
                                <a class="nav-link" id="nav-libro-banco1-tab" data-toggle="tab" href="#nav-libro-banco1" role="tab" aria-controls="nav-libro-banco1" aria-selected="false">LIBRO BANCO</a>
                                
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-conciliacion1" role="tabpanel" aria-labelledby="nav-conciliacion1-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden; border: double 8px #E71822;">
                                 @isset ($conciliacionbancaria->transacciones)
                                    {!! $conciliacionbancaria->transacciones !!}
                                @endisset
                            </div>
                            <div class="tab-pane fade" id="nav-libro-banco1" role="tabpanel" aria-labelledby="nav-libro-banco1-tab" style=" height:300px; overflow-y: scroll; border: double 8px #E71822;  overflow-x: hidden;">
                                <h2 class="text-center  font-weight-bold text-danger">Anexos de Control Interno</h2>
                                <h3 class="text-center font-weight-bold text-danger">Libro Banco</h3>
                                <div class="row p-3  mb-2 justify-content-center ">
                                    <div class="col-5">
                ...
                @elseif($datos->metodo == 'concatenado')
                  <div class="col-6 mt-2 ">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-conciliacion2-tab" data-toggle="tab" href="#nav-conciliacion2" role="tab" aria-controls="nav-conciliacion2" aria-selected="true">ENUNCIADOS</a>
                                <a class="nav-link" id="nav-libro-banco2-tab" data-toggle="tab" href="#nav-libro-banco2" role="tab" aria-controls="nav-libro-banco2" aria-selected="false">LIBRO BANCO</a>
                                
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-conciliacion2" role="tabpanel" aria-labelledby="nav-conciliacion2-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden; border: double 8px #E71822;">
                                 @isset ($conciliacionbancaria->transacciones)
                                    {!! $conciliacionbancaria->transacciones !!}
                                @endisset
                            </div>
                            <div class="tab-pane fade" id="nav-libro-banco2" role="tabpanel" aria-labelledby="nav-libro-banco2-tab" style=" height:300px; overflow-y: scroll; border: double 8px #E71822;  overflow-x: hidden;">
                                <h2 class="text-center  font-weight-bold text-danger">Anexos de Control Interno</h2>
                                <h3 class="text-center font-weight-bold text-danger">Libro Banco</h3>
                                <div class="row p-3  mb-2 justify-content-center ">
                                    <div class="col-5">
                ...
                @elseif($datos->metodo == 'concatenado')
                   <div class="col-6 mt-2 ">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-conciliacion3-tab" data-toggle="tab" href="#nav-conciliacion3" role="tab" aria-controls="nav-conciliacion3" aria-selected="true">ENUNCIADOS</a>
                                <a class="nav-link" id="nav-libro-banco3-tab" data-toggle="tab" href="#nav-libro-banco3" role="tab" aria-controls="nav-libro-banco3" aria-selected="false">LIBRO BANCO</a>
                             
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-conciliacion3" role="tabpanel" aria-labelledby="nav-conciliacion3-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden; border: double 8px #E71822;">
                                    @isset ($conciliacionbancaria->transacciones)
                                    {!! $conciliacionbancaria->transacciones !!}
                                @endisset
                            </div>
                            <div class="tab-pane fade" id="nav-libro-banco3" role="tabpanel" aria-labelledby="nav-libro-banco3-tab" style=" height:300px; overflow-y: scroll; border: double 8px #E71822;  overflow-x: hidden;">
                                <h2 class="text-center  font-weight-bold text-danger">Anexos de Control Interno</h2>
                                <h3 class="text-center font-weight-bold text-danger">Libro Banco</h3>
                                <div class="row p-3  mb-2 justify-content-center ">
                                    <div class="col-5">
