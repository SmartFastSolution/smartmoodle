            ...
            <a class="btn btn-dark mb-2" href="" @click.prevent="calculadora()">CALCULADORA</a>
                    ...
                    <div class="col-7">
                        <ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 12px;">
                            <li class="nav-item" role="presentation">
                              ...
                              <li class="nav-item" role="presentation">
                                <a class="nav-link " id="mn-calculo-hipotecario-tab" data-toggle="tab" href="#mn-calculo-hipotecario" role="tab" aria-controls="mn-calculo-hipotecario" aria-selected="true">CALCULO HIPOTECARIO</a>
                              </li>
                              <li class="nav-item" role="presentation">
                                <a class="nav-link" id="mn-calculo-quirografario-tab" data-toggle="tab" href="#mn-calculo-quirografario" role="tab" aria-controls="mn-calculo-quirografario" aria-selected="false">CALCULO QUIROGRAFARIO</a>
                              </li>
                              <li class="nav-item" role="presentation">
                                <a class="nav-link" id="mn-retencion-iva-tab" data-toggle="tab" href="#mn-retencion-iva" role="tab" aria-controls="mn-retencion-iva" aria-selected="false">RETENCION IVA</a>
                              </li>
                            </ul>
                        <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="mn-sobretiempo" role="tabpanel" aria-labelledby="mn-sobretiempo-tab">
                            <h4 class="text-center text-success font-weight-bold mt-2">Calculo Sobre Tiempo</h4>
                             <div class="form-group row">
                                ...
                                <div class="col-2">
                                  <input type="number" class="form-control text-right form-control-sm" v-model="sobretiempo.sueldo" placeholder="Sueldo">
                                </div>
                                  <div class="col-2">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-5 col-form-label">TOTAL HORAS SUPLEMENTARIAS</label>
                                <div class="col-2">
                                  <input type="number" class="form-control text-right form-control-sm" v-model="sobretiempo.total_suple" placeholder="Horas">
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-5 col-form-label">TOTAL HORAS EXTRAORDINARIAS</label>
                                <div class="col-2">
                                  <input type="number" class="form-control text-right form-control-sm" v-model="sobretiempo.total_extra" placeholder="Horas">
                                </div>
                                  <div class="col-2 text-center">
                                    X <span class="badge badge-success">@{{ sobretiempo.hora_trabajo }}</span> 
                                </div>
                                 ...
                                 <div class="col-2 text-right">
                                  <a @click.prevent="calculoSobre()" href="" class="btn btn-success btn-sm">CALCULAR SOBRETIEMPO</a>
                                </div>
                              </div>
                            <h2 class="text-danger font-weight-bold">TOTAL SOBRETIEMPO: <strong class="text-dark">@{{ sobretiempo.total }}</strong></h2>
                              </div>
                            <div class="tab-pane fade" id="mn-calculo-hipotecario" role="tabpanel" aria-labelledby="mn-calculo-hipotecario-tab">
                            ...
                            <div class="row">
                              ...
                              <div class="tab-pane fade" id="mn-calculo-quirografario" role="tabpanel" aria-labelledby="mn-calculo-quirografario-tab">
                            ...
                            <div class="row">
                              ...
                              <div class="tab-pane fade" id="mn-retencion-iva" role="tabpanel" aria-labelledby="mn-retencion-iva-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden;">
                            ...
                            <div class="p-2" style="border: double 4px red;">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="number" v-model="impuesto.sueldo"
                                            class="form-control  form-control-sm text-right" placeholder="Agregar Sueldo">
                                    </div>
                                  </div>

                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label">Comisiones y Sobretiempos</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-danger">Total Ingreso Grabable</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.ingreso_gravable }}</span>
                                    </div>
                                </div>
                                   <div class="form-group row">
                                    <label for="inputEmail3" class="col-9">- IIESS 9.45%</label>
                                    <div class="col-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.iies }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-danger">Ingreso Liquido Mensual</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.ingreso_liquido }}</span>
                                    </div>
                                </div>
                        {{--         <div class="row">
                                    <div class="col">
                                    ...
                                    <div class="col-12">
                                        <table class="table table-bordered table-sm mt-2"
                                            ...
                                            <tr v-for="(valore, index) in deducciones">
                                                <td class="text-left">
                                                    <input type="text" v-model="valore.descripcion" name="" class="form-control form-control-sm">
                                                </td>

                                                <td class="text-left">
                                                    <input type="number" v-model="valore.valor" name="" class="form-control form-control-sm">
                                                </td>
                                                <td align="center">
                                                    <a href="" class="btn btn-sm btn-danger" @click.prevent="borrarDeduccion(index)">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-danger">Ingreso Mensual</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.ingreso_mensual }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-danger">Ingreso Anual</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.ingreso_anual }}</span>
                                    </div>
                                </div>
                                <div class="form-group row border p-1">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-danger">BASE IMPONIBLE</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-success text-right" style="font-size: 18px">@{{ impuesto.base_imponible }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col">
                             ...
                             {{--     <div class="form-group row border p-1">
                                ...
                                <div class="form-group row border p-1">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-primary">FRACCION EXCEDENTE</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.fraccion_excedente }}</span>
                                    </div>
                                </div>
                                <h3 class="font-weight-bold">IMPUESTOS</h3>
                                <div class="form-group row border p-1">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-primary">FRACCION EXCEDENTE @{{impuesto.iva }} %</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.fraccion_excedente_iva }}</span>
                                    </div>
                                </div>
                                <div class="form-group row border p-1">
                                    <label for="inputEmail3" class="col-sm-9 col-form-label font-weight-bold text-primary">TOTAL IMPUESTO</label>
                                    <div class="col-sm-3 text-right">
                                        <span class="badge badge-info text-right" style="font-size: 18px">@{{ impuesto.total_impuesto }}</span>
                                    </div>
                                </div>
                            <h2 class="text-danger font-weight-bold">RETENCION MENSUAL: <strong class="text-dark">@{{ impuesto.total }}</strong></h2><a @click.prevent="limpiar()" href="" class="btn btn-success btn-sm">Limpiar</a>
                ...
                @if($datos->metodo == 'individual')
                    ...
                    <div class="col-12 mt-2 border border-bottom-0 border-left-0 border-right-0 border-danger" >
                        ...
                        <br>
                        <div class="col-12 mt-2" v-if="t_nomina.length > 0" style=" height:300px; overflow-y: scroll; overflow-x: hidden;">
                            <br>
