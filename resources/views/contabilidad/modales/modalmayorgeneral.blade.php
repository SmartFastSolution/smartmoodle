                    ...
                    <div class="col-6" style="border: double 8px #E71822;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="diario-mayor-tab" data-toggle="tab" href="#diario-mayor" role="tab" aria-controls="diario-mayor" aria-selected="true">DIARIO GENERAL</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="mayor-recargar-tab" data-toggle="tab" href="#mayor-recargar" role="tab" aria-controls="mayor-recargar" aria-selected="false">MAYOR GENERAL</a>
                            </li>
                            
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="diario-mayor" role="tabpanel" aria-labelledby="diario-mayor-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden;">
                            ...
                            <div class="tab-pane fade" id="mayor-recargar" role="tabpanel" aria-labelledby="mayor-recargar-tab" style=" height:300px; overflow-y: scroll; overflow-x: hidden;">
                                <div class="row justify-content-center">
