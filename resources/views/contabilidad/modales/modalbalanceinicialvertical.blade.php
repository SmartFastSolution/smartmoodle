{{-- TRANSACCION --}}
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="biv-transaccion" tabindex="-1"  role="dialog" aria-labelledby="bg-transaccionLabel" aria-hidden="true">
    ...
    <div class="col-12">
        <nav>
          <div style="font-size: 15px" class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="nav-biv-activo-corriente-tab" data-toggle="tab" href="#nav-biv-activo-corrente" role="tab" aria-controls="nav-biv-activo-corrente" aria-selected="true">Activo Corriente</a>

            <a class="nav-link" id="nav-biv-activo-no-corriente-tab" data-toggle="tab" href="#nav-biv-activo-no-corriente" role="tab" aria-controls="nav-biv-activo-no-corriente" aria-selected="false">Activo No Corriente</a>

            <a class="nav-link" id="nav-biv-pasivo-corriente-tab" data-toggle="tab" href="#nav-biv-pasivo-corriente" role="tab" aria-controls="nav-biv-pasivo-corriente" aria-selected="false">Pasivo Corriente</a>

            <a class="nav-link" id="nav-biv-pasivo-no-corriente-tab" data-toggle="tab" href="#nav-biv-pasivo-no-corriente" role="tab" aria-controls="nav-biv-pasivo-no-corriente" aria-selected="false">Pasivo No Corriente</a>

            <a class="nav-link" id="nav-biv-patrimonio-tab" data-toggle="tab" href="#nav-biv-patrimonio" role="tab" aria-controls="nav-biv-patrimonio" aria-selected="false">Patrimonio</a>

          </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-biv-activo-corrente" role="tabpanel" aria-labelledby="nav-biv-activo-corrente-tab">
             <div class="row">
                    <div class="col-6">
          ...
          <div class="tab-pane fade" id="nav-biv-activo-no-corriente" role="tabpanel" aria-labelledby="nav-biv-activo-no-corriente-tab">
                  <div class="row">
                    <div class="col-6">
                    ...
                    <tbody is="draggable" group="people" :list="a_nocorrientes" tag="tbody">
                        ...
                        <tr v-for="(balan, index) in a_nocorrientes">
                          ...
                          <td align="center"  width="50">
                            ...
                            <td align="center" width="50">
                            <a @click.prevent="deleteAcNoCooriente(index)" class="btn btn-danger">
                              <i class="fas fa-trash-alt"></i>
                            </a>
                          </td>
                        </tr>
        ...
        <div class="tab-pane fade" id="nav-biv-pasivo-corriente" role="tabpanel" aria-labelledby="nav-biv-pasivo-corriente-tab">
                  <div class="row">
                    <div class="col-6">
              ...
              <div class="row justify-content-around mb-2">
                ...
                <div class="tab-pane fade" id="nav-biv-pasivo-no-corriente" role="tabpanel" aria-labelledby="nav-biv-pasivo-no-corriente-tab">
                  <div class="row">
                    <div class="col-6">
              ...
              <div class="row justify-content-around mb-2">
                ...
                <div class="tab-pane fade" id="nav-biv-patrimonio" role="tabpanel" aria-labelledby="nav-biv-patrimonio-tab">
                  <div class="row">
                    <div class="col-6">
