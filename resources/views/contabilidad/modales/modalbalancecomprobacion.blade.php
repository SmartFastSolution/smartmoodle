                    ...
                    <div class="col-6 border border-bottom-0 border-left-0 border-top-0 border-danger">
                        ...
                        <table class="table table-bordered table-sm mb-2">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="number" v-model="balance.suma_debe" name="fecha"
                                            class="form-control">
                                    </td>
                                    <td>
                                        <input type="number" v-model="balance.suma_haber" name="fecha"
                                            class="form-control">
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <table class="table table-bordered table-sm mb-2">
                                <thead>
                                    <tr class="bg-dark">
                                        ...
                                        <td class="text-center" valign="center" v-if="balances.length >=1" colspan="2"
                                            rowspan="2">ACCIONES</td>
