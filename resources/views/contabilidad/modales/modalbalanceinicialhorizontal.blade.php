{{-- TRANSACCION --}}
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="bih-transaccion" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <nav>
                            <div style="font-size: 15px" class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-bih-activo-corriente-tab" data-toggle="tab"
                                    href="#nav-bih-activo-corrente" role="tab" aria-controls="nav-bih-activo-corrente"
                                    aria-selected="true">Activo Corriente</a>

                                <a class="nav-link" id="nav-bih-activo-no-corriente-tab" data-toggle="tab"
                                    href="#nav-bih-activo-no-corriente" role="tab"
                                    aria-controls="nav-bih-activo-no-corriente" aria-selected="false">Activo No
                                    Corriente</a>

                                <a class="nav-link" id="nav-bih-pasivo-corriente-tab" data-toggle="tab"
                                    href="#nav-bih-pasivo-corriente" role="tab" aria-controls="nav-bih-pasivo-corriente"
                                    aria-selected="false">Pasivo Corriente</a>

                                <a class="nav-link" id="nav-bih-pasivo-no-corriente-tab" data-toggle="tab"
                                    href="#nav-bih-pasivo-no-corriente" role="tab"
                                    aria-controls="nav-bih-pasivo-no-corriente" aria-selected="false">Pasivo No
                                    Corriente</a>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-bih-activo-corrente" role="tabpanel"
                                aria-labelledby="nav-bih-activo-corrente-tab">
                                <div class="row">
                                    <div class="col-6">
                    ...
                    @elseif($datos->metodo == 'concatenado')
                                    ...
                                    <div class="col-12 mt-2 p-2" style=" height:250px; overflow-y: scroll;">
                            ...
                            <div class="tab-pane fade" id="nav-bih-activo-no-corriente" role="tabpanel"
                                aria-labelledby="nav-bih-activo-no-corriente-tab">
                                <div class="row">
                                    <div class="col-6">
                    ...
                    @elseif($datos->metodo == 'concatenado')
                            ...
                            <div class="tab-pane fade" id="nav-bih-pasivo-corriente" role="tabpanel"
                                aria-labelledby="nav-bih-pasivo-corriente-tab">
                                <div class="row">
                                    <div class="col-6">
                    ...
                    @elseif($datos->metodo == 'concatenado')
                            ...
                            <div class="tab-pane fade" id="nav-bih-pasivo-no-corriente" role="tabpanel"
                                aria-labelledby="nav-bih-pasivo-no-corriente-tab">
                                <div class="row">
                                    <div class="col-6">
                    ...
                    @elseif($datos->metodo == 'concatenado')
                            ...
                            <div class="tab-pane fade" id="nav-bih-patrimonio" role="tabpanel"
                                aria-labelledby="nav-bih-patrimonio-tab">
                                <div class="row">
                                    <div class="col-6">
