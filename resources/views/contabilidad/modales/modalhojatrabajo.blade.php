{{-- TRANSACCION --}}
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="ht-transaccion" tabindex="-1"  role="dialog" aria-labelledby="bc-transaccionLabel" aria-hidden="true">
                ...
                <div class="col-12" >
                    ...
                    <ul class="nav nav-tabs" id="datosHoja" role="tablist">
                      <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="ht-balance-comprobacion-tab" data-toggle="tab" href="#ht-balance-comprobacion" role="tab" aria-controls="ht-balance-comprobacion" aria-selected="true">Balance de comprobacion</a>
                      </li>
                      <li class="nav-item" role="presentation">
                        <a class="nav-link" id="ht-mayor-general-tab" data-toggle="tab" href="#ht-mayor-general" role="tab" aria-controls="ht-mayor-general" aria-selected="false">Mayor General</a>
                      </li>

                    </ul>
                    <div class="tab-content" id="datosHojaContent" >
                      <div class="tab-pane fade show active" id="ht-balance-comprobacion" role="tabpanel" aria-labelledby="ht-balance-comprobacion-tab" style=" height:400px; overflow-y: scroll;">
                    ...
                    <table class="table table-bordered table-sm mb-2">
                     ...
                     {{--          <td align="center" width="50"><a @click.prevent="deleteBalance(index)"  class="btn btn-danger"><i
                      ...
                      <div class="tab-pane fade" id="ht-mayor-general" role="tabpanel" aria-labelledby="ht-mayor-general-tab" style=" height:400px; overflow-y: scroll; overflow-x: hidden;">
                   ...
                   <div class="col-12 mt-2 border border-bottom-0 border-left-0 border-right-0 border-danger">
                        <h2 class="text-center">AGREGAR MOVIMIENTOS</h2>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                          <model-select :options="options" v-model="registro.cuenta_id" placeholder="ELEGIR CUENTA"></model-select>
                            </div>
...
<tbody>
 ...
 <div class="modal fade" id="eliminar-ht" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="eliminar-htLabel" aria-hidden="true">
