    ...
    <div class="col-12">
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a v-if="utilidad == 'utilidad_neta'" class="nav-link" id="nav-er-utilidad-tab" data-toggle="tab" href="#nav-er-utilidad" role="tab" aria-controls="nav-er-utilidad" aria-selected="false">Utilidad</a>
          </div>
        </nav>
