        ...
        <div class="modal-content bg-light">
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 border border-bottom-0 border-left-0 border-top-0 border-danger">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <model-select :options="options" v-model="gasto.cuenta_id"
                                                            placeholder="ELEGIR CUENTA"></model-select>
                                        ...
                                        <table class="table table-bordered mt-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="number" v-model="utilidad_bruta.costo_venta"
                                                            class="form-control"></td>
                  ...
                  <div> <strong>Utilidad Neta del Ejercicio: </strong> @{{ totales.utilidad_ejercicio }}
                            </div>
                                ...
                                <table class="table table-bordered table-sm mb-2 p-2">
                                    ...
                                    <tbody is="draggable" group="people" :list="utilidades" tag="tbody">
                                        ...
                                        <tr v-for="(balan, index) in utilidades">
                                            ...
                                            <td align="center" width="50">
                                                <a @click.prevent="warningEliminarUtilidad(index)"
                                                    class="btn btn-danger">
                                                    <i class="fas fa-trash-alt"></i>
                                                </a>
                                            </td>
