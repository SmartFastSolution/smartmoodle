        ...
        <div id="nomina_empleado">
            ...
            <div class="row p-4  mb-3 justify-content-center ">
                <div class="col-5 mb-3">
                    <input class="form-control text-center" type="text" v-model="nombre"
            ...
            <table class="table table-bordered table-sm">
                <thead class="bg-dark">
                    <tr>
                        ...
                        <th class="text-center" valign="center" v-if="t_nomina.length >=1" colspan="2" rowspan="2">
                            ACCIONES</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr v-for="(n, index) in t_nomina">
                        ...
                        <td align="center" width="50"><a @click.prevent="editNominaFuera(index)"
