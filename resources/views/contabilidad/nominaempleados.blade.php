    ...
    <table class="table table-bordered table-sm">
        <thead class="bg-dark">
            <tr>
                ...
                <th class="text-center" valign="center" v-if="t_nomina.length >=1" colspan="2" rowspan="2">ACCIONES</th>
            </tr>
        </thead>
        ...
        <tbody>
            <tr v-for="(n, index) in t_nomina">
                ...
                <td align="center" width="50"><a @click.prevent="editNominaFuera(index)" class="btn btn-warning"><i
                            class="fas fa-edit"></i></a></td>
                <td align="center" width="50"><a @click.prevent="WarningEliminarNomina(index)" class="btn btn-danger"><i
