    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            <tr v-for="(c , index) in t_compras">
                ...
                <td align="center" width="50"><a @click.prevent="WarningEliminarCompra(index)" class="btn btn-danger"><i
        ...
        <tbody>
            <tr v-for="(v , index) in t_ventas">
                ...
                <td align="center" width="50"><a @click.prevent="editVentaFuera(index)" class="btn btn-warning"><i
                            class="fas fa-edit"></i></a></td>
                <td align="center" width="50"><a @click.prevent="WarningEliminarVenta(index)" class="btn btn-danger"><i
                            class="fas fa-trash-alt"></i></a></td>
