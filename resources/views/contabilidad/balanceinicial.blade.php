...
<div class="tab-pane fade  show active" id="b_horizontal" role="tabpanel" aria-labelledby="b_horizontal-tab">
    ...
    <div class="tab-pane border border-danger p-3 fade @if ($datos->balance_inicial_horizontal == 1) show active @endif"
        id="b_horizontal" role="tabpanel" aria-labelledby="b_horizontal-tab">
        @endif
  ...
  <div class="col-12">
        ...
        <div class="row justify-content-between">
            <div class="col-6">
                ...
                <h3 class="text-primary">CORRIENTE <a data-toggle="tooltip" data-placement="top"
                        title="Agregar Activo Corriente" @click="abrirActivoC()"
                ...
                <draggable class="list-group list-group-flush" :list="a_nocorrientes" group="people"
                    ...
                    <div v-for="(element, index) in a_nocorrientes" :key="element.name">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @{{ element.nom_cuenta }}
                            <span class="badge-pill">@{{ decimales(element.saldo) }} <a @click="editANocorriente(index)"
                                    class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a><a
            ...
            <div class="col-6">
                ...
                <h3 class="text-primary">CORRIENTE <a data-toggle="tooltip" data-placement="top"
                        title="Agregar Pasivo Corriente" @click="abrirPasivoC()"
                ...
                <draggable class="list-group list-group-flush" :list="p_nocorrientes" group="people"
                    ...
                    <div v-for="(element, index) in p_nocorrientes" :key="element.name">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @{{ element.nom_cuenta }}
                            <span class=" badge-pill">@{{ decimales(element.saldo) }} <a
                                    @click="editPNocorriente(index)" class="btn btn-warning btn-sm mr-1"><i
                                        class="fas fa-edit"></i></a><a @click="deletePaNoCooriente(index)"
                ...
                <h3 class="text-danger">PATRIMONIO <a data-toggle="tooltip" data-placement="top"
    ...
    <div class="tab-pane fade" id="b_vertical" role="tabpanel" aria-labelledby="b_vertical-tab">
        ...
        @elseif($datos->metodo == 'individual')
        <div class="tab-pane border border-danger p-3  fade @if ($datos->balance_inicial_vertical == 1) show active @endif"
            id="b_vertical" role="tabpanel" aria-labelledby="b_vertical-tab">
            @endif
            {{--       <div class="row mb-2 p-sm-2">
      <div class="col-12">
        <table class="table table-sm ">
          <tbody>
                        ...
                        <div v-for="(element, index) in a_corrientes" :key="element.name">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @{{ element.nom_cuenta }}<span class="badge-pill">@{{ decimales(element.saldo) }} <a
                                        ...
                                        class="btn btn-danger btn-sm re_diario"><i
                                            class="fas fa-trash-alt"></i></a></span>
                            </li>
                        </div>
                    </draggable>
                    ...
                    <draggable class="list-group list-group-flush" :list="a_nocorrientes" group="people"
                        ...
                        <div v-for="(element, index) in a_nocorrientes" :key="element.name">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @{{ element.nom_cuenta }}
                                <span class="badge-pill">@{{ decimales(element.saldo) }} <a
                                        @click="editANocorriente(index)" class="btn btn-warning btn-sm mr-1"><i
                                            class="fas fa-edit"></i></a><a @click="deleteAcNoCooriente(index)"
                                        class="btn btn-danger btn-sm re_diario"><i
                                            class="fas fa-trash-alt"></i></a></span>
                            </li>
                        </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 20px;" class="badge-danger badge">
                                    @{{ total_balance_inicial.t_activo }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <draggable class="list-group list-group-flush" :list="p_corrientes" group="people"
                        ...
                        <div v-for="(element, index) in p_corrientes" :key="element.name">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @{{ element.nom_cuenta }}
                                <span class=" badge-pill">@{{ decimales(element.saldo) }} <a
                                        @click="editPcorriente(index)" class="btn btn-warning btn-sm mr-1"><i
                                            class="fas fa-edit"></i></a><a @click="deletePaCooriente(index)"
                                        class="btn btn-danger btn-sm re_diario"><i
                                            class="fas fa-trash-alt"></i></a></span>
                            </li>
                        </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 20px;" class="badge-danger badge">
                                    @{{ total_balance_inicial.t_pasivo }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <h2 class="text-center font-weight-bold text-danger">PATRIMONIO <a data-toggle="tooltip"
                    data-placement="top" title="Agregar Patrimonio" @click="abrirPatrimonio()"
                    class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a></h2>
                    ...
                    <draggable class="list-group list-group-flush" :list="patrimonios" group="people"
                        ...
                        <div v-for="(element, index) in patrimonios" :key="element.name">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @{{ element.nom_cuenta }}
                                <span class="badge-pill">@{{ decimales(element.saldo) }} <a
                                        @click="editPatrimonio(index)" class="btn btn-warning btn-sm mr-1"><i
                                            class="fas fa-edit"></i></a><a @click="deletePatrimonio(index)"
                                        class="btn btn-danger btn-sm re_diario"><i
                                            class="fas fa-trash-alt"></i></a></span>
                            </li>
                        </div>
