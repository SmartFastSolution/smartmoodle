 ...
 <div class="tab-pane fade show active" id="b_horizontal" role="tabpanel" aria-labelledby="b_horizontal-tab">
                     ...
                     <tr>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-primary" data-toggle="modal"
                                 data-target="#a_corriente" @click="limpiar()">
                                 Activo Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn  btn-sm btn-outline-primary" data-toggle="modal"
                                 data-target="#a_nocorriente" @click="limpiar()">
                                 Activo No Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn  btn-sm btn-outline-success" data-toggle="modal"
                                 data-target="#p_corriente" @click="limpiar()">
                                 Pasivo Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-success" data-toggle="modal"
                                 data-target="#p_nocorriente" @click="limpiar()">
                                 Pasivo No Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-secondary" data-toggle="modal"
                                 data-target="#patrimonio" @click="limpiar()">
                                 Patrimonio
                             </button>
                         </td>
                     </tr>
     ...
     <div class="row p-3  mb-2 justify-content-center ">
         ...
         <div class="col-8 mb-3">
             <input class="form-control" type="text" v-model="balance_inicial.nombre"
                 placeholder="Nombre del balance inicial" name="">
         </div>
         <div class="col-5">
             ...
             <table>
                 <tbody>
                     <tr>
                         ...
                         <td style="font-size: 20px;" class="badge-danger badge">@{{ total_balance_inicial.t_pasivo }}
                         </td>
                     </tr>
                 </tbody>
             </table>
             ...
             <table>
                 <tbody>
                     <tr>
                         ...
                         <td style="font-size: 20px;" class="badge-danger badge">@{{ total_balance_inicial.t_activo }}
                         </td>
                     </tr>
                 </tbody>
             </table>
                 ...
                 <tbody>
                     <tr>
                         ...
                         <td style="font-size: 20px;" class="badge-danger badge">
                             @{{ total_balance_inicial.t_patrimonio_pasivo }}</td>
                     </tr>
                 </tbody>
             </table>
             <button type="button" class="btn btn-sm  btn-block btn-outline-secondary" data-toggle="modal"
                 data-target="#pasivo_patrimonio">
                 TOTAL
             </button>
         </div>
     </div>
 ...
 <div class="tab-pane fade" id="b_vertical" role="tabpanel" aria-labelledby="b_vertical-tab">
             ...
             <table class="table table-sm ">
                 <tbody>
                     <tr>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-primary" data-toggle="modal"
                                 data-target="#a_corriente2" @click="limpiar()">
                                 Activo Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn  btn-sm btn-outline-primary" data-toggle="modal"
                                 data-target="#a_nocorriente2" @click="limpiar()">
                                 Activo No Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn  btn-sm btn-outline-success" data-toggle="modal"
                                 data-target="#p_corriente2" @click="limpiar()">
                                 Pasivo Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-success" data-toggle="modal"
                                 data-target="#p_nocorriente2" @click="limpiar()">
                                 Pasivo No Corriente
                             </button>
                         </td>
                         <td>
                             <button type="button" class="btn btn-sm  btn-outline-secondary" data-toggle="modal"
                                 data-target="#patrimonio2" @click="limpiar()">
                                 Patrimonio
                             </button>
                         </td>
                     </tr>
     ...
     <div class="row">
         ...
         <div class="col-12">
             ...
             <button type="button" class="btn btn-sm  btn-block btn-outline-secondary" data-toggle="modal"
                 data-target="#pasivo_patrimonio2">
                 TOTAL
             </button>
         </div>
     </div>
