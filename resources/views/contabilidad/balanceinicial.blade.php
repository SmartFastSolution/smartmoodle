 ...
 <div class="tab-pane fade show active" id="b_horizontal" role="tabpanel" aria-labelledby="b_horizontal-tab">
            ...
            <div class="row justify-content-between">
                            <div class="col-5  ">
                                ...
                                <h3 class="text-primary">CORRIENTE <a data-toggle="modal" data-target="#a_corriente" @click="limpiar()"
                                ...
                                <draggable class="list-group list-group-flush" :list="a_corrientes" group="people" @change="cambioActivo">
                                    <div v-for="(element, index) in a_corrientes" :key="element.name">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="badge-pill">@{{ element.saldo }} <a @click="editAcorriente(index)"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ b_initotal.t_a_corriente }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>

                                <br><br>
                                <h3 class="text-primary">NO CORRIENTE <a data-toggle="modal" data-target="#a_nocorriente"
                                        @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a></h3><br>
                                <draggable class="list-group list-group-flush" :list="a_nocorrientes" group="people"
                                    ...
                                    <div v-for="(element, index) in a_nocorrientes" :key="element.name">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            @{{ element.nom_cuenta }}
                                            <span class="badge-pill">@{{ element.saldo }} <a @click="editANocorriente(index)"
                                                    class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a><a
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ b_initotal.t_a_nocorriente }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-5 ">
                                ...
                                <h3 class="text-primary">CORRIENTE <a data-toggle="modal" data-target="#p_corriente" @click="limpiar()"
                                ...
                                <draggable class="list-group list-group-flush" :list="p_corrientes" group="people"
                                    ...
                                    <div v-for="(element, index) in p_corrientes" :key="element.name">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            @{{ element.nom_cuenta }}
                                            <span class=" badge-pill">@{{ element.saldo }} <a @click="editPcorriente(index)"
                                                    class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a><a
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ b_initotal.t_p_corriente }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br><br>

                                <h3 class="text-primary">NO CORRIENTE <a data-toggle="modal" data-target="#p_nocorriente"
                                ...
                                <draggable class="list-group list-group-flush" :list="p_nocorrientes" group="people"
                                    ...
                                    <div v-for="(element, index) in p_nocorrientes" :key="element.name">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            @{{ element.nom_cuenta }}
                                            <span class=" badge-pill">@{{ element.saldo }} <a @click="editPNocorriente(index)"
                                                    class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a><a
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            <td width="250">TOTAL PAS. NO CORR.</td>
                                            <td class="text-right"> <span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ b_initotal.t_p_no_corriente }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br><br>
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ total_balance_inicial.t_pasivo }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br><br>

                                <h3 class="text-danger">PATRIMONIO <a data-toggle="modal" data-target="#patrimonio" @click="limpiar()"
                                        class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a></h3><br>
                                <draggable class="list-group list-group-flush" :list="patrimonios" group="people"
                                    ...
                                    <div v-for="(element, index) in patrimonios" :key="element.name">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            @{{ element.nom_cuenta }}
                                            <span class="badge-pill">@{{ element.saldo }} <a @click="editPatrimonio(index)"
                                                    class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a><a
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"> <span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ b_initotal.t_patrimonio }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><span style="font-size: 20px; margin-left: 35px;"
                                                    class="badge badge-danger">@{{ total_balance_inicial.t_activo }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right"><input type="text" v-model="total_balance_inicial.t_patrimonio_pasivo"
...
<div class="tab-pane fade" id="b_vertical" role="tabpanel" aria-labelledby="b_vertical-tab">
                ...
                <h2 class="text-center font-weight-bold text-danger">ACTIVOS</h2>
                      <div class="row">
                          <div class="col-7">
                                  <h3 class="text-primary">ACTIVOS CORRIENTE <a data-toggle="modal" data-target="#a_corriente2"
                                          @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a>
                                  </h3><br>
                                  <draggable class="list-group list-group-flush" :list="a_corrientes" group="people" @change="cambioActivo">
                                      <div v-for="(element, index) in a_corrientes" :key="element.name">
                                          <li class="list-group-item d-flex justify-content-between align-items-center">
                                              @{{ element.nom_cuenta }}<span class="badge-pill">@{{ element.saldo }} <a
                          ...
                          <div class="col-12">
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td class="font-weight-bold" style="font-size: 20px;" width="2000">TOTAL ACT. CORR.
                                              </td>
                                              <td style="font-size: 20px;" class="badge-danger badge">@{{ b_initotal.t_a_corriente }}
                                              </td>
                                          </tr>
                                      </tbody>
                                  </table>
                          ...
                          <div class="col-7">
                                  <h3 class="text-primary">ACTIVOS NO CORRIENTE <a data-toggle="modal" data-target="#a_nocorriente2"
                                          @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a>
                                  </h3><br>
                                  <draggable class="list-group list-group-flush" :list="a_nocorrientes" group="people"
                                      @change="cambioActivoNo()">
                           ...
                           <div class="col-12">
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td class="font-weight-bold" style="font-size: 20px;" width="2000">TOTAL ACT. NO CORR.
                                              </td>
                                              <td style="font-size: 20px;" class="badge-danger badge">
                                                  @{{ b_initotal.t_a_nocorriente }}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                                  <table>
                                      <tbody>
                                          <tr>
                                              ...
                                              <td style="font-size: 20px;" class="badge-danger badge">
                                                  @{{ total_balance_inicial.t_activo }}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                ...
                <div class="row">
                          <div class="col-7 ">
                                  <h3 class="text-primary">PASIVOS CORRIENTE <a data-toggle="modal" data-target="#p_corriente2"
                                          @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a>
                                  </h3>
                                  <draggable class="list-group list-group-flush" :list="p_corrientes" group="people"
                                      @change="cambioPasivo()">
                          ...
                          <div class="col-12">
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td class="font-weight-bold" style="font-size: 20px;" width="2000">TOTAL PAS. CORR.
                                              </td>
                                              <td style="font-size: 20px;" class="badge-danger badge">@{{ b_initotal.t_p_corriente }}
                                              </td>
                                          </tr>
                                      </tbody>
                                  </table>
                                    ...
                                    <br><br>
                        <div class="col-7 ">
                                  <h3 class="text-primary">NO CORRIENTE <a data-toggle="modal" data-target="#p_nocorriente2"
                                          @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a>
                                  </h3>
                                  <draggable class="list-group list-group-flush" :list="p_nocorrientes" group="people"
                                      @change="cambioPasivoNo()">
                                  ...
                                  <table>
                                      <tbody>
                                          <tr>
                                              ...
                                              <td style="font-size: 20px;" class="badge-danger badge">
                                                  @{{ b_initotal.t_p_no_corriente }}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                        </div>
                                  ...
                                  <table>
                                      <tbody>
                                          <tr>
                                              ...
                                              <td style="font-size: 20px;" class="badge-danger badge">
                                                  @{{ total_balance_inicial.t_pasivo }}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                        </div>
                </div>
              <h2 class="text-center font-weight-bold text-danger">PATRIMONIO <a data-toggle="modal" data-target="#patrimonio2"
                      @click="limpiar()" class="btn btn-sm btn-info text-light"><i class="fa fa-plus"></i></a></h2>
                        <div class="row">
                              <div class="col-7">
                                  <draggable class="list-group list-group-flush" :list="patrimonios" group="people"
                                      @change="cambioPatrimonio()">
                              ...
                              <div class="col-12">
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td class="font-weight-bold" style="font-size: 20px;" width="2000">TOTAL PATRIMONIO.
                                              </td>
                                              <td style="font-size: 20px;" class="badge-danger badge">@{{ b_initotal.t_patrimonio }}
                                              </td>
                                          </tr>
                                      </tbody>
                                  </table>
                              ...
                              <div class="col-12">
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td class="font-weight-bold" style="font-size: 20px;" width="750">TOT. PAS. Y PATRI.
                                              </td>
                                              <td><input type="text" v-model="total_balance_inicial.t_patrimonio_pasivo"
              ...
              <div class="row justify-content-center">
                  <a class="btn p-2 mt-3 btn-outline-info" @click.prevent="guardarBalanceInicial()">Guardar Balance
                      Inicial</a>
              </div>
