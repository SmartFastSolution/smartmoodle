      		...
      		<div class="col-12">
					<table class="table table-bordered table-sm">
					  ...
					  <tbody v-for="(registro, id) in registros" @change="totalDebe()">
					  	<tr v-for="(diar, index) in registro.debe">
					  		...
					  		<td align="center" width="125">@{{ diar.saldo }}</td>
					  		<td align="center" width="125"></td>
                      		<td v-if="diar.fecha !== '' && diar.fecha !== null"  align="center" width="50"><a @click="debeEditRegister(id)" class="btn btn-warning btn-sm"><i class="fas fas fa-edit"></i></a></td>
                      		<td v-if="diar.fecha != '' && diar.fecha !== null" align="center" width="50"><a @click="deleteRegistro(id)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a></td>
					  	</tr>
					  		 ...
					  		 <tbody is="draggable" group="people" :list="edit.haber" tag="tbody">
					            <tr v-for="(diar, index) in edit.haber">
							  	...
							  	<tr v-if="edit.comentario !== ''">
						  			...
						  			<td></td>
						  			<td></td>
						  			<td><a @click="comentarioEdit" class="btn btn-warning btn-sm"><i class="fas fas fa-edit"></i></a></td>
					  		</tr>
			            	</tbody>				  		
					  	</table>
					  	<table  class="table table-bordered table-sm">
					...
					<form action="">
						...
						<div v-if="edit.debe.length >= 1" class="row justify-content-around mb-2">
							<a href="#"  class="btn btn-outline-secondary" data-toggle="modal" data-target="#debe">Agregar Debe</a> 
							<a href="#"  class=" btn btn-outline-secondary" data-toggle="modal" data-target="#haber" >Agregar Haber</a>
							<a href="#" v-if="edit.comentario == ''"  class=" btn btn-outline-primary" data-toggle="modal" data-target="#comentario" >Agregar Comentario</a> 
							<a href="#" class="addDiario btn btn-outline-warning" @click.prevent="updaterRegister()">Actualizar Transaccion</a>
						</div>
						<div v-else class="row justify-content-around mb-2">	
							...
							<a href="#"  class=" btn btn-outline-primary" data-toggle="modal" data-target="#comentario" >Agregar Comentario</a> 
							<a href="#" class="addDiario btn btn-outline-success" @click.prevent="guardarRegistro()">Agregar Transaccion</a>
	                    </div>
