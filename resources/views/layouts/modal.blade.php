          ...
          <div class="col-12">
             <form action="{{ route('admin.taller4') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea required=""  required="" type="text" name="enunciado" class="form-control" ></textarea> 
              </div>
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Materia:</label>
                <select name="materia_id" class="custom-select" >
        ...
        <div class="row justify-content-center">
          <div class="col-12">
             <form action="{{ route('admin.taller5') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group row mb-3 p-3">
                ...
                <label for="" class="col-form-label">Alternativa 1:</label>
                  <textarea required=""  required="" name="alternativac_1a" class="form-control" rows="5"></textarea>
                <label for="" class="col-form-label">Alternativa 2:</label>
                  <textarea required=""  required="" name="alternativac_1b" class="form-control" rows="5"></textarea>
               ...
               <div class="form-group row mb-3 p-3">
                ...
                <label for="" class="col-form-label">Alternativa 1:</label> 
                  <textarea required=""  required="" name="alternativac_2a" class="form-control" rows="5"></textarea>

                <label for="" class="col-form-label">Alternativa 2:</label> 
                  <textarea required=""  required="" name="alternativac_2b" class="form-control" rows="5"></textarea>
               ...
               <div class="form-group row mb-3 p-3">
                ...
                <label for="" class="col-form-label">Alternativa 1:</label> 
                  <textarea required=""  required="" name="alternativac_3a" class="form-control" rows="5"></textarea>

                <label for="" class="col-form-label">Alternativa 2:</label> 
                  <textarea required=""  required="" name="alternativac_3b" class="form-control" rows="5"></textarea>
              ...
              <label for="" class="col-form-label">Alternativa 1:</label> 
                  <textarea required=""  required="" name="alternativac_4a" class="form-control" rows="5"></textarea>

                <label for="" class="col-form-label">Alternativa 2:</label> 
                  <textarea required=""  required="" name="alternativac_4b" class="form-control" rows="5"></textarea>
              ...
              <label for="" class="col-form-label">Alternativa 1:</label> 
                  <textarea required=""  required="" name="alternativac_5a" class="form-control" rows="5"></textarea>

                <label for="" class="col-form-label">Alternativa 2:</label> 
                  <textarea required=""  required="" name="alternativac_5b" class="form-control" rows="5"></textarea>
               ...
               <div class="form-group row mb-3 p-3">
                ...
                <label for="" class="col-form-label">Alternativa 1:</label> 
                  <textarea required=""  required="" name="alternativac_6a" class="form-control" rows="5"></textarea>

                <label for="" class="col-form-label">Alternativa 2:</label> 
                  <textarea required=""  required="" name="alternativac_6b" class="form-control" rows="5"></textarea>
              ...
              <div class="form-group">
                ...
                @foreach ($materias = App\Materia::get() as $materia)
                 ...
                 <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="text" data-role="tagsinput" name="alternativas1" class="form-control" >
                </div>
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <label for="concepto6" class="col-form-label">Alternativas:</label>
                  <input required="" type="text" data-role="tagsinput"  name="alternativas2" class="form-control" >
                </div>
                  ...
                  <label for="concepto6" class="col-form-label">Alternativas:</label>
                  <input required="" type="text" data-role="tagsinput"  name="alternativas3" class="form-control" >
                </div>
                  ...
                  <label for="concepto6" class="col-form-label">Alternativas:</label>
                  <input required="" type="text" data-role="tagsinput"  name="alternativas4" class="form-control" >
                </div>
                  ...
                  <label for="concepto6" class="col-form-label">Alternativas:</label>
                  <input required="" type="text" data-role="tagsinput"  name="alternativas5" class="form-control" >
                </div>
                  ...
                  <label for="concepto6" class="col-form-label">Alternativas:</label>
                  <input required="" type="text" data-role="tagsinput"  name="alternativas6" class="form-control" >
                </div>
...
<div class="form-row">            <div class="form-group col-4">
                <label for="" class="col-form-label">Valor :</label>
                <input required="" type="text" name="valor" class="form-control">
              </div>
              <div class="form-group col-4">
          ...
          <div class="col-12">
             <form action="{{ route('admin.taller25') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea required=""  required="" name="enunciado" class="form-control" id=""  rows="5"></textarea>
              </div>
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Materia:</label>
                <select name="materia_id" class="custom-select" >
