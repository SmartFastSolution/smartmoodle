        ...
        <div class="row justify-content-center">
             <form action="{{ route('admin.taller1') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input required="" type="text" name="enunciado" class="form-control" >
              </div>
              <div class="form-group">
             ...
             <form action="{{ route('admin.taller5') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group row mb-3 p-3">
                ...
                <input required="" type="text" name="alternativac_1a" class="form-control">
              ...
              <div class="form-group">
                ...
                @foreach ($materias = App\Materia::get() as $materia)
                 ...
                 <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="text" data-role="tagsinput required=" name="alternativas1" class="form-control" >
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="file" name="img1" class="custom-file" >
                    ...
                    <input required="" type="text" name="definicion1" class="form-control" >
                </div>
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="file" name="img3" class="custom-file" id="img3">
                    ...
                    <input required="" type="text" name="definicion3" class="form-control" >
                </div>
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="file" name="img4" class="custom-file" id="img4">
                    ...
                    <input required="" type="text" name="definicion4" class="form-control" >
                </div>
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="file" name="img5" class="custom-file" id="img5">
                    ...
                    <input required="" type="text" name="definicion5" class="form-control" >
                </div>
                ...
                <div class="form-group bg-light p-2">
                  ...
                  <input required="" type="file" name="img6" class="custom-file" id="img6">
                    ...
                    <input required="" type="text" name="definicion6" class="form-control" >
                </div>
          ...
          <div class="col-12">
             <form action="{{ route('admin.taller10') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group bg-light p-2">
                    <label for="concepto6" class="col-form-label">Definicion 2:</label>
                    <input required="" type="text" name="definicion2" class="form-control" >
                </div>
           ...
           <div class="col-12">
             <form action="{{ route('admin.taller12') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="descripcion1" ></textarea>
              </div>

              <div class="form-group">
                <label for="" class="col-form-label">Descripcion 2:</label>
                <textarea class="form-control" name="descripcion2" ></textarea>
              </div>

              <div class="form-group">
                <label for="" class="col-form-label">Descripcion 3:</label>
                <textarea class="form-control" name="descripcion3" ></textarea>
              </div>

              <div class="form-group">
                <label for="" class="col-form-label">Descripcion 4:</label>
                <textarea class="form-control" name="descripcion4" ></textarea>
              </div>

              <div class="form-group">
                <label for="" class="col-form-label">Descripcion 5:</label>
                <textarea class="form-control" name="descripcion5" ></textarea>
              </div>
...
<div class="modal fade" id="taller28" tabindex="-1" role="dialog" aria-labelledby="taller34Label" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
