        ...
        <div class="container mb-3" id="cuentas">
            <div class="row justify-content-center">
                ...
                <div class="col-6" style="border: solid 8px #CD1D1D; overflow-y: scroll; height: 500px;">
                    ...
                    <div class="row p-3">
                        <input type="text" class="col-10 form-control form-control-sm mr-2" v-on:keydown.enter.prevent
                            v-model="activo.cuenta" placeholder="Agregar Activo">
                        <button class="btn btn-success btn-sm" @click.prevent="agregarActivo">Agregar</button>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li v-for="(acti, index) in activos"
                            class="list-group-item d-flex justify-content-between align-items-center">
                            <input type="text" class="form-control form-control-plaintext" v-model="acti.cuenta">
                            <span class=""><a href="" class="btn btn-sm btn-danger" @click.prevent="borrarActivo(index)"><i
                ...
                <div class="col-6" style="border: solid 8px #CD1D1D; overflow-y: scroll; height: 500px;">
                    ...
                    <div class="row p-3">
                        <input type="text" class="col-10 form-control form-control-sm mr-2" v-on:keydown.enter.prevent
                            v-model="pasivo.cuenta" placeholder="Agregar Pasivo">
                        <button class="btn btn-success btn-sm" @click.prevent="agregarPasivo">Agregar</button>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li v-for="(pasi, index) in pasivos"
                            class="list-group-item d-flex justify-content-between align-items-center">
                            <input type="text" class="form-control form-control-plaintext" v-model="pasi.cuenta">
                            <span class=""><a href="" class="btn btn-sm btn-danger" @click.prevent="borrarPasivo(index)"><i
                                        class="fa fa-trash"></i></a></span>
                        </li>
                    </ul>
                </div>
                    ...
                    axios.post(url, {
                        ...
                        Swal.fire({
                            ...
                            if (response.data.rol == 'docente') {
                                window.location = "/sistema/contenido/" + response.data.id +
                                    "/talleres/resueltos";
