...
<form action="{{ route('taller30', ['idtaller' => $d]) }}" method="POST">
	...
	<div class="container mb-4 ">
		...
		<div class="col-8 form-inline border border-danger p-3">
			<h2 class="text-center"><strong>EDITORIAL</strong></h2>
			<p class="text-justify " style="font-size: 16px;">
				El <input required type="text" class="input-css m-1" name="abreviatura1" size="40"> dejó  claro  que  serán  clausurados  todos  los  negocios  que no  entreguen  sus  respectivos  comprobantes  de  ventas destacando  lo siguiente  con  respecto  a  la <input required size="40" type="text" class="input-css m-1" name="abreviatura2"> ,  que  en  ella deberá  constar  el <input required size="40" type="text" size="40" class="input-css m-1" name="abreviatura3">   de  la  empresa,  la  determinación  de <input required size="40" type="text" size="40" class="input-css m-1" name="abreviatura4">  de los <input required size="40" type="text" class="input-css m-1" name="abreviatura5">   y se  debe  desglosar  el <input required size="40" type="text" class="input-css m-1" name="abreviatura6">   y su  respectivo <input required size="40" type="text" class="input-css m-1" name="abreviatura7">   
			</p>
			<p class="text-justify" style="font-size: 16px;">
				La <input required size="40" type="text" class="input-css m-1" name="abreviatura8">   felicitó  por  su  buen  desempeño  al <input required size="40" type="text" class="input-css m-1" name="abreviatura9"> , por  administrar sus  fondos  de  una  manera  eficaz  a  las  distintas  entidades públicas  tales  como:  el <input required size="40" type="text" class="input-css m-1" name="abreviatura10">   por  la  implementación  de  sus equipos  quirúrgicos,  al <input required size="40" type="text" class="input-css m-1" name="abreviatura11">   por  ofrecer  a  las  personas  de bajos  recursos  un  hogar  digno,  entre  otros.
			</p>
		</div>
	</div>
	 <div class="row justify-content-center">
