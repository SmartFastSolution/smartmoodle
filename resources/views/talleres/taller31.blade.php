...
<h3 class="text-center mt-5 mb-3 text-info">EN EL SIGUIENTE COLLAGE APLIQUE FIGURAS QUE SE  RELACIONEN CON CONTABILIDAD HOTELERA, CON EFICACIA</h3>
	<div class="container">
	<form action="{{ route('taller_31', ['idtaller' => $d]) }}"
      class="dropzone"
