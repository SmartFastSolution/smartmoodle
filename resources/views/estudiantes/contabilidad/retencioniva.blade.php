                    ...
                    <td>
                        <div class="col-sm-8">
                            <input disabled="" class="form-control  text-right  form-control-sm" type="number"
                                step="0.01" v-model="total.t_ivaventa" placeholder="IVA EN VENTAS" name="">
                        </div>
                    </td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="col-sm-8">
                            <input disabled="" class="form-control  text-right  form-control-sm" type="number"
                                step="0.01" v-model="total.t_ivacompra" placeholder="- IVA EN COMPRAS" name="">
                        </div>
                    </td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="col-sm-8">
                            <input disabled="" class="form-control  text-right  form-control-sm" type="number"
                                step="0.01" v-model="total.result_iva" placeholder="RES. IVA" name="">
                        </div>
                    </td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="col-sm-8">
                            <input disabled="" class="form-control  text-right  form-control-sm" type="number"
                                step="0.01" v-model="total.t_reten" placeholder="+ RET. IVA" name="">
                        </div>
                    </td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="col-sm-8">
                            <input disabled="" class="form-control  text-right  form-control-sm" type="number"
                                step="0.01" v-model="total.total_pagar" placeholder="TOTAL A PAGAR" name="">
                        </div>
                    </td>
                </tr>
            </tbody>
