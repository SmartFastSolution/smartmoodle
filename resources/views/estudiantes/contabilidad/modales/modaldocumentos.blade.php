      ...
      <div class="modal-body">
        ...
        <div class="row ">
          <div class="col-6 mb-2">
            {{-- <input disabled="" type="text" v-model="cheque.tipo_cheque" class="form-control mt-2" > --}}

            <input disabled="" type="text" v-model="cheque.banco" class="form-control mt-2" >
          </div>  
        ...
        <div class="row">
          ...
          <div class="col-8">
            <input disabled="" type="text" v-model="cheque.girador" class="form-control" >
          </div>
          <div class="col-2">
            <label for="">
              CHEQUE <input disabled="" type="number" v-model="cheque.n_cheque" size="1" class="form-control form-control-sm text-right" name="">
            </label><br>
            <div class="row">
              <div class="col-2"><label for="">
              US
            </label></div>
              <div class="col-8"><input disabled="" type="number" name="cantidad" v-model="cheque.cantidad" class="form-control text-right" size="2" ></div>
            </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-8">
            <input disabled="" type="text" v-model="cheque.cantidad_letra" class="form-control" > 
          </div>
          <div class="col-2">
            DOLARES
          </div>
        ...
        <div class="row">
          <div class="col-6 align-self-start pb-5">
            <div class="row">
              <div class="col-6"><input disabled="" name="lugar" v-model="cheque.ciudad" class="form-control" type="text" ></div>
              <div class="col-6"><input disabled="" name="fecha" v-model="cheque.fecha" class="form-control" type="date" ></div>
            </div>
              <div class="row">
          ...
          <div class="col-6 col align-self-end text-center">
            <input disabled="" name="firma" v-model="cheque.firma" class="form-control" type="text" >
        ...
        <div class="row p-3 m-0 mb-2 border border-info">
          <div class="col-7">
            <div class="row mb-1">
              ...
              <div class="col-6"><input disabled=""  name="nombre" type="text " v-model="nota_credito.razon_social" class="form-control"></div>
            </div>
            <div class="row  mb-1">
          ...
          <div class="col-5">
            ...
            {{-- <div class="row">
              ...
              <div class="col-7"><input disabled=""  name="emision" type="text " v-model="nota_credito." class="form-control"></div>
            </div> --}}
          </div>
            <div class="col-12 mt-2">
            <div class="row mb-1">
              <div class="col-6"><label for="">COMPROBANTE QUE MODIFICA</label></div>
              <div class="col-6"><input disabled=""  name="nombre" type="text " v-model="nota_credito.comprobante" class="form-control"></div>
            </div>
            <div class="row  mb-1">
            ...
            <div class="row  mb-1">
              ...
              <div class="col-6"><input disabled=""  type="text " v-model="nota_credito.razon_modificacion" class="form-control"></div>
            </div>
          </div>
        </div>
          ...
          <table class="table table-bordered table-sm">
            ...
            <tbody class="prin">
              <tr v-for="(dato, index) in nota_credito.datos">
                <td width="100"> <input disabled="" type="number" v-model="dato.codigo" name="codigo[]" class="form-control text-right" ></td>
                <td width="100"><input disabled="" type="text" v-model="dato.cod_aux" name="cod_aux[]" class="form-control text-right" ></td>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><input disabled=""  type="number" v-model="nota_credito.totales.subtotal_12" name="subtotal_12" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL 0%</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.subtotal_0" name="subtotal_0" class="form-control text-right"></td>
                
              </tr>
              <tr>
                <th scope="row">SUBTOTAL No objeto de IVA</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.subtotal_no_iva" name="subtotal_iva" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL Exento de IVA</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.subtotal_exe_iva" name="subtotal_siniva" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL SIN IMPUESTOS</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.subtotal_sin_va" name="subtotal_sin_imp" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">TOTAL DESCUENTO</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.total_descuento" name="descuento_total" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">ICE</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.ice" name="ice" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">IVA 12%</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.iva_12" name="iva12" class="form-control text-right"></td>
              </tr>
               <tr>
                <th scope="row">IRBPNR</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.irbpnr" name="irbpnr" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">VALOR TOTAL</th>
                <td><input disabled=""  type="number" v-model="nota_credito.totales.total" name="valor_total" class="form-control text-right"></td>
              </tr>
        ...
        <div class="row p-3 m-0 mb-2 border border-info">
          <div class="col-7">
            <div class="row mb-3">
              ...
              <div class="col-6"><input disabled=""  name="nombre" type="text " v-model="factura.razon_social"  class="form-control"></div>
            </div>
            <div class="row">
          ...
          <div class="col-5">
            <div class="row mb-3">
              <div class="col-5"><label class="col-form-label">R.U.C/C.I. :</label></div>
              <div class="col-7"><input disabled=""  name="ruc" type="text " v-model="factura.ruc" class="form-control"></div>
            </div>
            <div class="row">
              <div class="col-5"><label class="col-form-label" for="">GUÍA DE REMISIÓN :</label></div>
              <div class="col-7"><input disabled=""  name="emision" type="text " v-model="factura.guia_remision" class="form-control"></div>
            </div>
          </div>
        </div>
        <div class="row p-3  mb-2 ">
        ...
        <div class="col-6">
          <table class="table table-bordered">
           <tbody>
              <tr>
                <th scope="row">SUBTOTAL 12%</th>
                <td><input disabled=""  type="number" v-model="factura.totales.subtotal_12" name="subtotal_12" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL 0%</th>
                <td><input disabled=""  type="number" v-model="factura.totales.subtotal_0" name="subtotal_0" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL No objeto de IVA</th>
                <td><input disabled=""  type="number" v-model="factura.totales.subtotal_no_iva" name="subtotal_iva" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL Exento de IVA</th>
                <td><input disabled=""  type="number" v-model="factura.totales.subtotal_exe_iva" name="subtotal_siniva" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">SUBTOTAL SIN IMPUESTOS</th>
                <td><input disabled=""  type="number" v-model="factura.totales.subtotal_sin_va" name="subtotal_sin_imp" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">TOTAL DESCUENTO</th>
                <td><input disabled=""  type="number" v-model="factura.totales.total_descuento" name="descuento_total" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">ICE</th>
                <td><input disabled=""  type="number" v-model="factura.totales.ice" name="ice" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">IVA 12%</th>
                <td><input disabled=""  type="number" v-model="factura.totales.iva_12" name="iva12" class="form-control text-right"></td>
              </tr>
               <tr>
                <th scope="row">IRBPNR</th>
                <td><input disabled=""  type="number" v-model="factura.totales.irbpnr" name="irbpnr" class="form-control text-right"></td>
              </tr>
              <tr>
                <th scope="row">VALOR TOTAL</th>
                <td><input disabled=""  type="number" v-model="factura.totales.total" name="valor_total" class="form-control text-right"></td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <div class="col-10 p-2  ">
              ...
              <div class="row justify-content-around">
                ...
                <div class="col-4 form-inline">
                  <label for="">Por $<input disabled v-model="pagare.por" type="number" class="form-control text-right"></label>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <p class=" text-justify">
                    Debo y pagare de la fecha en <input disabled  v-model="pagare.fecha" type="text" class=" input-css form-control-sm m-1" size="10"> fijos en esta ciudad o en el lugar en que se me reconvenga a la orden de <input disabled  v-model="pagare.nombre" type="text" class=" input-css  form-control-sm " size="40"> la cantidad de <input disabled  v-model="pagare.cantidad" type="text" class=" input-css form-control-sm" size="65"> por igual valor que tengo recibido, en calidad de préstamo y en dinero efectivo para destinarlo a negocios de comercio; esta cantidad me oblifo a devolveria al vencimiento del plazo expresado, enmonedas de este curso legal.
                  </p>
                  <p class=" text-justify">
                    Tambien me obligo a pagar el interes del <input disabled    type="text" v-model="pagare.interes" class=" input-css  form-control-sm m-1" size="1"> por ciento anual desde el vencimiento hasta la completa cancelacion y en el caso de mora, a pagar todos los gastos judiciales y extrajudiciales que ocasione el cobro, bastando para terminar el montode tales gastos la sola afirmacion del agreedor.</p>
                    <p class=" text-justify">
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="">Ciudad  -   Fecha</label><input disabled    class="form-control form-control-sm" v-model="pagare.ciudad" type="text">
                  </div>
                  <div class="col-6">
                    <label for="">Fecha Vencimiento</label><input disabled   class="form-control form-control-sm" v-model="pagare.fecha_vencimiento" type="text">
                ...
                <div class="row justify-content-end mt-3">
                  <div class="col-10">
                    <p class=" text-justify">Me constituyo fiador llano pagador del señor <input disabled    class=" input-css  form-control-sm mb-1 ml-1 mr-1" size="55" v-model="pagare.señor" type="text"> por las obligaciones que hemos contraído en el pagaré anterior haciendo de deuda ajena deuda propia renunciando  los beneficios de orden y de excusión de bienes del deudor principalmente el de división y cualquier ley, excepción o derecho que pueda favorecerme así como la apelación y el recurso de hecho.  Quedo sometido a los jueces de  Provincia o de la que elija el acreedor. Sin protesto.</p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6 ">
                    <div class="form-group">
                      ...
                      <input disabled type="text" v-model="pagare.deudor1" class="form-control form-control-sm" >
                    </div>
                  </div>
                  <div class="col-6 mt-4">
                    <div class="form-group">
                      <label >GARANTE(ES)</label>
                      <input disabled type="text" v-model="pagare.garante" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-6 ">
                    <div class="form-group">
          ...
          {{--       <div class="col-lg-2">
              ...
              <div class="row mb-2">
                <div class="col-12">
                  ...
                  <input type="number" disabled v-model="papeleta_deposito.cuenta" class="form-control form-control-sm">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputEmail3" class="col-sm-3 col-form-label">Nombre</label>
                <div class="col-sm-9">
                  <input type="text" disabled v-model="papeleta_deposito.nombre" class="form-control" id="inputEmail3">
                </div>
              </div>
              <div class="form-group row mb-2">
                <label for="inputPassword3" class="col-sm-3 col-form-label">Lugar y Fecha</label>
                <div class="col-sm-9">
                  <input type="text" disabled v-model="papeleta_deposito.lugar_fecha" class="form-control" id="inputPassword3">
                </div>
              </div>
            </div>
            <div class="col-lg-6">
                  ...
                  <div class="form-group row mt-2">
                    <div class="col-sm-9">
                      <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="number" disabled v-model="papeleta_deposito.cantidad" class="form-control  text-right">
                      </div>
            ...
            <div class="col-lg-6 align-self-end">
              ...
              <div class="row mt-5 text-center">
                <div class="col-lg-6">
                  <input type="text" disabled v-model="papeleta_deposito.depositante" class="form-control">
        ...
        <div class=" p-3" style="box-shadow: 5px 5px 15px 0px  #3A27F4">
          <div class="row mb-2">
            ...
            <div class="col-7 align-self-center">
              <div class="row mb-2">
                ...
                <div class="col-8">
                  <input disabled type="date" v-model="letra_cambio.vencimiento" class="form-control text-center" >
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-3">
                  <input disabled type="number" v-model="letra_cambio.numero" class="form-control" >
                </div>
                <div class="col-5 border border-info p-2">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <input disabled type="number" v-model="letra_cambio.por" class="form-control text-right" >
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-12 text-center ">
              <div class="row mb-1">
                <div class="col-6">
                  <input disabled type="text" v-model="letra_cambio.ciudad" class="form-control" >
                </div>
                <div class="col-6">
                  <input disabled type="date" v-model="letra_cambio.fecha" class="form-control" >
                </div>
              </div>
              <h6>Ciudad y fecha</h6>
            </div>
            <div class="col-12 ">
              <input disabled type="text" v-model="letra_cambio.orden_de" class="form-control" >
              <h6>A la orden de</h6>
            </div>
            <div class="col-12 ">
              <input disabled type="text" v-model="letra_cambio.de" class="form-control" >
              <h6>De</h6>
            </div>
            <div class="col-12 ">
              <input disabled type="text" v-model="letra_cambio.cantidad" class="form-control" >
              <h6>La Cantidad de</h6>
            </div>
            <div class="col-12 form-inline">
              <p class="col-form-label">Con  el  interés  del <input disabled type="number" style="width: 100px;" v-model="letra_cambio.interes" class="form-control text-right" > por  ciento  anual,   desde <input disabled v-model="letra_cambio.desde" type="text" class="form-control" > Sin protesto.   Exímese  de presentación  para  aceptación  y  pago  así  como  de  avisos  por  falta  de  estos  hechos.</p>
            </div>
            <div class="col-12 ">
              <div class="row mb-1">
                <div class="col-6">
                  <input disabled type="text" v-model="letra_cambio.direccion" class="form-control" >
                </div>
                <div class="col-6">
                  <input disabled type="text" v-model="letra_cambio.ciudad2" class="form-control" >
                </div>
              </div>
              <div class="row mb-1">
          ...
          <div class="row justify-content-center">
            <div class="col-5 text-center">
              <input disabled type="text" v-model="letra_cambio.atentamente" class="form-control" >
              <h1>Atentamente</h1>
            </div>
          </div>
        </div>
