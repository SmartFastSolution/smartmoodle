                        ...
                        <div class="col-12 col-sm-12 col-md-2 mb-3">
                            <div class="list-group" id="list-tab" role="tablist">
                                @foreach ($modulo as $key => $element)
                                    <a class="list-group-item list-group-item-action @if ($key==0) active @endif" id="list-{{ $element->code }}-list"
                                        data-toggle="list" href="#list-{{ $element->code }}" role="tab"
                                        aria-controls="{{ $element->code }}">{{ $element->name }}</a>
                                @endforeach
                        ...
                        <div class="col-12 col-sm-12 col-md-10">
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane @if ($modulo[0]->code == 'kardex') show active @endif fade" id="list-kardex" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.kardex')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'kardex-promedio') show active @endif "
                                    id="list-kardex-promedio" role="tabpanel"
                                    aria-labelledby="list-kardex-promedio-list">
                                    @include('estudiantes.contabilidad.kardex_promedio')
                                </div>
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'balance_comp') show active @endif " id="list-balance_comp" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.balancecomprobacion')
                                </div>


                                <div class="tab-pane fade @if ($modulo[0]->code == 'messages') show active @endif border border-danger " id="list-messages"
                                    role="tabpanel"
                                    aria-labelledby="list-messages-list">
                                    @include('estudiantes.contabilidad.diariogeneral')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'balance-ajustado') show active @endif "
                                    id="list-balance-ajustado" role="tabpanel"
                                    aria-labelledby="list-balance-ajustado-list">
                                    @include('estudiantes.contabilidad.balanceajustado')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code == 'mayor-general') show active @endif border border-danger " id="list-mayor-general"
                                    role="tabpanel"
                                    aria-labelledby="list-mayor-general-list">
                                    @include('estudiantes.contabilidad.mayorgeneral')
                                </div>
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'hoja-trabajo') show active @endif " id="list-hoja-trabajo" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.hojatrabajo')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code == 'diario') show active @endif border border-danger p-4" id="list-diario"
                                    role="tabpanel"
                                    aria-labelledby="list-diario-list">

                                    <ul class="nav nav-tabs" id="bInicial" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#b_horizontal"
                                                role="tab" aria-controls="b_horizontal" aria-selected="true">Balance Inicial
                                                Horizontal</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="bInicialContent">
                                        @include('estudiantes.contabilidad.balanceinicial')
                                    </div>
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'estado-resultado') show active @endif "
                                    id="list-estado-resultado" role="tabpanel"
                                    aria-labelledby="list-estado-resultado-list">
                                    @include('estudiantes.contabilidad.estadoresultado')
                                </div>


                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'balance-general') show active @endif "
                                    id="list-balance-general" role="tabpanel"
                                    aria-labelledby="list-balance-general-list">
                                    @include('estudiantes.contabilidad.balancegeneral')
                                </div>
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'asento-cierre') show active @endif " id="list-asento-cierre" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.asientosdecierre')
                                </div>
                                {{-- ARREGLADOS --}}

                                {{-- parte anexos arreglado --}}

                                <div class="tab-pane fade @if ($modulo[0]->code == 'libro-caja') show active @endif " id="list-libro-caja" role="tabpanel"
                                    aria-labelledby="list-libro-caja-list">
                                    @include('estudiantes.contabilidad.librocaja')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'conciliacion-bancaria') show active @endif "
                                    id="list-conciliacion-bancaria" role="tabpanel"
                                    aria-labelledby="list-conciliacion-bancaria-list">
                                    @include('estudiantes.contabilidad.conciliacionbancaria')
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'arqueo-caja') show active @endif " id="list-arqueo-caja" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.arqueocaja')
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'libro-banco') show active @endif " id="list-libro-banco" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.librobanco')
                                </div>
                                ...
                                <div class="tab-pane fade @if ($modulo[0]->code == 'retencion-iva') show active @endif " id="list-retencion-iva" role="tabpanel"
                                    ...
                                    @include('estudiantes.contabilidad.retencioniva')
                                </div>

                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'nomina-empleado') show active @endif "
                                    id="list-nomina-empleado" role="tabpanel"
                                    aria-labelledby="list-nomina-empleado-list">
                                    @include('estudiantes.contabilidad.nominaempleados')
                                </div>
                                <div class="tab-pane fade @if ($modulo[0]->code ==
                                    'provision-beneficio') show active @endif "
                                    id="list-provision-beneficio" role="tabpanel"
                                    aria-labelledby="list-provision-beneficio-list">
                                    @include('estudiantes.contabilidad.provisiondebeneficio')
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            @if ($datos->balance_inicial_vertical == 1)
                                ...
                                @include('estudiantes.contabilidad.balance_inicial_vertical')
                ...
                <div class="row justify-content-center">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="text" disabled value="{{ $relacion[0]->calificacion }}" class="form-control"
                                name="calificacion" placeholder="Añada una nota al estudiante">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Retroalimentación</label>
                            <textarea disabled class="form-control" name="retroalimentacion" rows="3"
                                placeholder="Agregue una retroalimentacion">{{ $relacion[0]->retroalimentacion }}</textarea>
                        </div>
                    </div>
                </div>
            @endif
                    ...
                    obtenerBalance: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.tipo == _this.tipo || response.data.datos == true) {
                                ...
                                _this.total_balance_inicial.t_patrimonio_pasivo = response.data
                                    .total_pasivo_patrimonio;
                                _this.total_balance_inicial.t_activo = response.data.completo
                                    .total_activo
                                _this.total_balance_inicial.t_pasivo = response.data.completo
                                    .total_pasivo
                                _this.b_initotal.t_a_corriente = response.data.completo
                                    .total_activo_corriente
                                _this.b_initotal.t_a_nocorriente = response.data.completo
                                    .total_activo_nocorriente
                                _this.b_initotal.t_p_corriente = response.data.completo
                                    .total_pasivo_corriente
                                _this.b_initotal.t_p_no_corriente = response.data.completo
        ...
        if (document.getElementById('b_vertical')) {
            ...
            const b_ver = new Vue({
                ...
                methods: {
                    ...
                    obtenerBalance: function() {
                        var _this = this;
                        var url = '/sistema/admin/docente/balance-vertical';
                        axios.post(url, {
                            id: _this.id_taller,
                            tipo: _this.tipo,
                            user: _this.user_id,
                    ...
                    obtenerKardexFifo: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                ...
                                _this.prueba.cantidad.inventario_inicial = response.data.informacion
                                    .inv_inicial_cantidad;
                                _this.prueba.cantidad.adquicisiones = response.data.informacion
                                    .adquisicion_cantidad;
                                _this.prueba.cantidad.ventas = response.data.informacion
                                    .ventas_cantidad;
                                _this.prueba.cantidad.inventario_final = response.data.informacion
                                    .inv_final_cantidad;
                                _this.prueba.precio.inventario_inicial = response.data.informacion
                                    .inv_inicial_precio;
                                _this.prueba.precio.adquicisiones = response.data.informacion
                                    .adquisicion_precio;
                                _this.prueba.precio.ventas = response.data.informacion.ventas_precio;
                                _this.prueba.precio.inventario_final = response.data.informacion
                                    .inv_final_precio;
                                this.sumasTotales();
                ...
                methods: {
                    ...
                    obtenerBalanceCom: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                toastr.info("Balance de Comprobacion cargado correctamente",
                                    "SmartLearn", {
                                        "timeOut": "3000"
                                    });
                    ...
                    obtenerHojita: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                ...
                                _this.nombre = response.data.nombre;
                                _this.suman.balance_comp.total_debe = response.data.totales
                                    .bc_total_debe;
                                _this.suman.balance_comp.total_haber = response.data.totales
                                    .bc_total_haber;
                                _this.suman.ajustes.total_debe = response.data.totales
                                    .ajuste_total_debe;
                                _this.suman.ajustes.total_haber = response.data.totales
                                    .ajuste_total_haber;
                                _this.suman.balance_ajustado.total_debe = response.data.totales
                                    .ba_total_debe;
                                _this.suman.balance_ajustado.total_haber = response.data.totales
                                    .ba_total_haber;
                                _this.suman.estado_resultado.total_debe = response.data.totales
                                    .er_total_debe;
                                _this.suman.estado_resultado.total_haber = response.data.totales
                                    .er_total_haber;
                                _this.suman.balance_general.total_debe = response.data.totales
                                    .bg_total_debe;
                                _this.suman.balance_general.total_haber = response.data.totales
                                    .bg_total_haber;
                            }
                        }).catch(function(error) {
                    ...
                    obtenerEstadoResultado: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                ...
                                _this.totales.utilidad_bruta_ventas = response.data.estadoresultado
                                    .utilidad_bruta_ventas
                                _this.utilidad_bruta.venta = response.data.estadoresultado.venta
                                _this.utilidad_bruta.costo_venta = response.data.estadoresultado
                                    .costo_venta
                                _this.totales.utilidad_ejercicio = response.data.estadoresultado
                                    .utilidad_ejercicio
                                _this.totales.utilidad_liquida = response.data.estadoresultado
                                    .utilidad_liquida
                                _this.totales.utilidad_neta_o = response.data.estadoresultado
                                    .utilidad_neta_o
                ...
                methods: {
                    ...
                    obtenerConciliacionBancaria: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                toastr.info("Anexo Conciliación Bancaria cargado correctamente",
                                    "SmartLearn", {
                                        "timeOut": "3000"
                                    });
                ...
                methods: {
                    ...
                    obtenerRetencionIva: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                toastr.info("Anexo Retencion del Iva cargado correctamente",
                                    "SmartLearn", {
                                        "timeOut": "3000"
                                    });
                ...
                methods: {
                    ...
                    obtenerNomina: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                toastr.info("Anexo Nómina de Empleado cargado correctamente",
                                    "SmartLearn", {
                                        "timeOut": "3000"
                                    });
                                this.nombre = response.data.nombre;
                ...
                methods: {
                    ...
                    obtenerProvision: function() {
                        ...
                        axios.post(url, {
                            ...
                            if (response.data.datos == true) {
                                toastr.success("Anexo Provisión Beneficio Social cargado correctamente",
                                    "SmartLearn", {
                                        "timeOut": "3000"
                                    });
