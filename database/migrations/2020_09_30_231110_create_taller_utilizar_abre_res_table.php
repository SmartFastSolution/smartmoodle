...
class CreateTallerUtilizarAbreResTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('taller_utilizar_abre_res', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('taller_utilizar_abre_res');
    }
}
