...
class CreateTalleLocalizarAbreResTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('talle_localizar_abre_res', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('talle_localizar_abre_res');
    }
}
